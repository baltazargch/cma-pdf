...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.175}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Mesoplodon bowdoini}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Zifio de Andrew
\end{minipage}
...
\emph{Mesoplodon bowdoini}. En: SAyDS--SAREM (eds.) Categorización 2019
de los mamíferos de Argentina según su riesgo de extinción. Lista Roja
de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.175}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Mesoplodon_bowdoini}
...
Es una especie poco conocida en todo el mundo, y prácticamente
desconocida para la Argentina, donde se la registró en las Islas
Malvinas y en Tierra del Fuego (ejemplar varado en el año 2003). Se
considera que no hay información adecuada para hacer una evaluación
directa o indirecta de su riesgo de extinción, basándose en su
distribución y/o condición de la población, es por ello que la especie
se categoriza como Datos Insuficientes (DD).
