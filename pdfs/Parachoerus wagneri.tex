...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Parachoerus wagneri}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Pecarí quimilero
\end{minipage}
...
\textbf{Citar como:} Camino, Micaela; Torres, Ricardo M.. (2019).
...
\textbf{Torres, Ricardo M.} &  & Instituto de Diversidad y Ecología Animal (IDEA), CONICET-Universidad Nacional de Córdoba, Córdoba, Argentina\\
\bottomrule
\end{tabu}
