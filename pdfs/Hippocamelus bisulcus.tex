...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.209}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Hippocamelus bisulcus}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Huemul
\end{minipage}
...
\textbf{Citar como:} Pastore, Hernán; Aprile, Gustavo. (2019).
\emph{Hippocamelus bisulcus}. En: SAyDS--SAREM (eds.) Categorización
2019 de los mamíferos de Argentina según su riesgo de extinción. Lista
Roja de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.209}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Hippocamelus_bisulcus}
...
Las poblaciones de Huemul de Argentina son pequeñas y se encuentran
fragmentadas, además enfrentan una declinación continua por factores
como la pérdida y degradación del hábitat, caza furtiva, la
interferencia con ungulados exóticos y la depredación por perros. El
tamaño de la población estimada en Argentina es de menos de 2.500
individuos maduros (se infiere que hay menos de 400 huemules adultos),
donde se estima que ninguna subpoblación contiene más de 250 individuos
maduros y que están enfrentando diversas amenazas que generan una
disminución continua en el número de individuos maduros en cada
subpoblación, por lo tanto, se la categoriza como En Peligro (EN)
siguiendo el criterio C2a(i).
