...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.169}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Megaptera novaeangliae}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Ballena jorobada
\end{minipage}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Megaptera_novaeangliae}
...
Aunque no se dispone de una evaluación actual completa de la población
en el Mar Argentino, la población a nivel mundial se ha recuperado.
Parece improbable, basándose en las recientes tasas de incremento
poblacional, que esté por debajo del umbral (50\% del nivel poblacional
de 1940) que calificaría a la especie para su inclusión en la categoría
Vulnerable (VU) bajo el criterio A. Las estimaciones poblacionales
disponibles señalan la existencia de más de 60.000 ballenas jorobadas;
muy por encima de los umbrales de los criterios C y D para la categoría
Vulnerable (VU). El rango de distribución de la ballena jorobada no está
restringido, y por lo tanto, la especie no califica para su inclusión en
el Criterio B. Por lo tanto, la especie es categorizada como de
...
\textbf{\cellcolor{gray!6}{Iñíguez Bessega, Miguel A.}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{Fundación Cethus, Vicente López, Buenos Aires, Argentina}\\
...
\textbf{\cellcolor{gray!6}{Negrete, Javier}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{Instituto Antártico Argentino, CABA, Argentina}\\
