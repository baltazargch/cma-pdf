...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.177}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Mesoplodon hectori}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Zifio de Héctor
\end{minipage}
...
\textbf{Citar como:} Paso Viola, Natalia ; García, Néstor A.. (2019).
\emph{Mesoplodon hectori}. En: SAyDS--SAREM (eds.) Categorización 2019
de los mamíferos de Argentina según su riesgo de extinción. Lista Roja
de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.177}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Mesoplodon_hectori}
...
poblacional para especie en el Mar Argentino. En función de ello, se
considera que no hay información adecuada para hacer una evaluación de
la especie basándose en la distribución y/o condición de la población.
Clasificándose como Datos Insuficientes (DD).
...
\textbf{Paso Viola, Natalia} &  & Laboratorio de Ecología y Conservación de Vida Silvestre, CADIC-CONICET, Ushuaia, Tierra del Fuego, Argentina\\
\bottomrule
\end{tabu}
