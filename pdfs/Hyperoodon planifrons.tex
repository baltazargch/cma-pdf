...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.174}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Hyperoodon planifrons}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Zifio nariz de botella austral
\end{minipage}
...
\textbf{Citar como:} Hevia, Marta; García, Néstor A.. (2019).
\emph{Hyperoodon planifrons}. En: SAyDS--SAREM (eds.) Categorización
2019 de los mamíferos de Argentina según su riesgo de extinción. Lista
Roja de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.174}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Hyperoodon_planifrons}
...
especie en el Mar Argentino. Si bien a nivel global la especie se
considera abundante y no amenazada (Taylor et al.~2008), no se cuenta
con estimaciones de abundancia o tendencia poblacional para la especie
en el Mar Argentino. En función de ello, se considera que no hay
