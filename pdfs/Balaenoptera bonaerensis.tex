...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.171}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Kogia breviceps}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Cachalote pigmeo
\end{minipage}
...
\textbf{Citar como:} Giardino, Gisela; García, Néstor A.. (2019).
\emph{Kogia breviceps}. En: SAyDS--SAREM (eds.) Categorización 2019 de
los mamíferos de Argentina según su riesgo de extinción. Lista Roja de
los mamíferos de Argentina. \url{http://doi.org/10.31687/SaremLR.19.171}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Kogia_breviceps}
...
Es una especie con escaso nivel de conocimiento en todos los aspectos de
su taxonomía, biología y ecología en el mar argentino. No se cuenta con
estimaciones de abundancia o tendencia poblacional para esta especie en
el país, por lo que se la categoriza como Datos Insuficientes (DD).
