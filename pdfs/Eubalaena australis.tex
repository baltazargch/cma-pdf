...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.161}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Eubalaena australis}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Ballena franca austral
\end{minipage}
...
\textbf{Citar como:} D´Agostino, Valeria C.; Mandiola, Agustina;
Bastida, Ricardo; Giardino, Gisela; García, Néstor A.; Romero, M.
Alejandra; Coscarella, Mariano A.. (2019). \emph{Eubalaena australis}.
...
Argentina. \url{http://doi.org/10.31687/SaremLR.19.161}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Eubalaena_australis}
...
En los últimos años se ha reportado un crecimiento de la población de
ballena franca austral del Atlántico Sudoccidental de 0,06\% para el
número total de ballenas y del 2,30\% para las crías (Crespo et
al.~2018). Además, recientemente, se ha registrado una tendencia por
recolonizar áreas de distribución previas a su explotación comercial. En
la actualidad no existen amenazas para la especie, a excepción de las
heridas causadas por las gaviotas a las crías en el área de Península
Valdés. Por lo tanto, en este contexto se considera genuino el cambio de
categoría desde su última categorización, clasificándola como
...
\textbf{\cellcolor{gray!6}{D´Agostino, Valeria C.}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{Laboratorio de Mamíferos Marinos, CESIMAR-CONICET, Puerto Madryn, Chubut, Argentina}\\
...
\textbf{Chalcobsky, Ailén} &  & Laboratorio de Mamíferos Marinos, CESIMAR-CONICET, Puerto Madryn, Chubut, Argentina\\
...
\textbf{Fernández, Santiago} &  & Laboratorio de Mamíferos Marinos, CESIMAR-CONICET, Puerto Madryn, Chubut, Argentina\\
