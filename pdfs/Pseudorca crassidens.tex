...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.193}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Pseudorca crassidens}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Falsa Orca
\end{minipage}
...
\textbf{Citar como:} Cáceres-Saez, Iris; Loizaga de Castro, Rocío;
Denuncio, Pablo E.; Svendsen, Guillermo; Dellabianca, Natalia A.;
García, Néstor A.. (2019). \emph{Pseudorca crassidens}. En: SAyDS--SAREM
(eds.) Categorización 2019 de los mamíferos de Argentina según su riesgo
de extinción. Lista Roja de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.193}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Pseudorca_crassidens}
...
La especie está catalogada como Datos Insuficientes (DD) debido a la
escasez de registros vivos, la ausencia de una estimación del tamaño de
la población y el conocimiento limitado del rango de distribución de la
especie (proveniente de algunos registros de varamientos en la costa
Argentina);~que impiden definir su estatus de conservación en el país.
La mayoría de los estudios de esta especie provienen de otras partes del
mundo. Si bien previamente la especie fue clasificada como de
Preocupación Menor (LC), los criterios utilizados se basaron en datos
referidos a su distribución global, por lo tanto, el cambio de categoría
es no genuino.
...
\textbf{Dellabianca, Natalia A.} &  & Laboratorio de Ecologia y Conservación de Vida Silvestre, CADIC-CONICET y Museo Acatushún de Aves y Mamíferos Marinos Australes, Ushuaia, Tierra del Fuego, Argentina\\
...
\begin{tabu} to \linewidth {>{}l>{\raggedright\arraybackslash}p{2cm}>{\raggedright}X}
\toprule
\textbf{\cellcolor{gray!6}{Cappozzo, H. Luis}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{Museo Argentino de Ciencias Naturales Bernardino Rivadavia - CONICET, CABA, Argentina}\\
\textbf{Faiella, Adrián} &  & Centro de Rehabilitación de Fauna, Aquarium Mar del Plata, Buenos Aires, Argentina\\
\textbf{\cellcolor{gray!6}{Rodríguez Heredia, Sergio A.}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{Fundación Mundo Marino, San Clemente del Tuyú, Buenos Aires, Argentina}\\
\bottomrule
\end{tabu}
