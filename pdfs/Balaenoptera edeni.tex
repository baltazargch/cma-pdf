...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.173}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Berardius arnuxii}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Zifio de Arnoux
\end{minipage}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Berardius_arnuxii}
...
Argentino, los registros son extremadamente escasos y solamente de
varamientos. Por lo cual se estima que no hay información adecuada para
hacer una evaluación de la especie basándose en la distribución y/o
