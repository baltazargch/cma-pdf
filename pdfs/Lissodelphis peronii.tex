...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.195}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Lissodelphis peronii}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Delfín liso austral
\end{minipage}
...
\textbf{Citar como:} Giardino, Gisela; Denuncio, Pablo E.; García,
Néstor A.. (2019). \emph{Lissodelphis peronii}. En: SAyDS--SAREM (eds.)
Categorización 2019 de los mamíferos de Argentina según su riesgo de
extinción. Lista Roja de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.195}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Lissodelphis_peronii}
...
Los registros sobre la presencia de la especie en el Mar Argentino son
verdaderamente escasos y en su mayoría de varamientos durante las
décadas de '60 y '70. En función de ello, se considera que no hay
...
Datos Insuficientes (DD). Se considera que el cambio con respecto a las
categorizaciones previas es no genuino, ya que no existía información
suficiente a nivel regional para categorizarlo como Preocupación Menor
(LC).
