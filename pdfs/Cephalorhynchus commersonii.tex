...
\fancyhead[R]{\textbf{http://doi.org/10.31687/SaremLR.19.194}}
...
\vspace{0.3cm}
\fontsize{20}{24}\selectfont\textit{Cephalorhynchus commersonii}

\vspace{0.3cm}
\fontsize{30}{36}\selectfont Tonina overa
\end{minipage}
...
\textbf{Citar como:} Coscarella, Mariano A.; Dellabianca, Natalia A.;
Cáceres-Saez, Iris; Hevia, Marta; Morgenthaler, Annick; Failla,
Mauricio; Iñíguez Bessega, Miguel A.; Loizaga de Castro, Rocío. (2019).
\emph{Cephalorhynchus commersonii}. En: SAyDS--SAREM (eds.)
Categorización 2019 de los mamíferos de Argentina según su riesgo de
extinción. Lista Roja de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.194}
...
\includegraphics[width=1\linewidth]{maps/Cetartiodactyla/Cephalorhynchus_commersonii}
...
La tonina overa es una de las especies de delfín más comúnmente avistada
a lo largo de la costa del mar argentino. A pesar de que actualmente no
existen programas de monitoreo dedicados a la especie, los núcleos
poblacionales identificados no muestran evidencia de declinación en sus
números. Esta especie no cumple con ninguno de los criterios que definen
las categorías de amenaza.~ Por lo tanto, se concluye clasificarla como
...
\textbf{\cellcolor{gray!6}{Hevia, Marta}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{Fundación Cethus, Vicente López, Buenos Aires, Argentina}\\
\addlinespace
