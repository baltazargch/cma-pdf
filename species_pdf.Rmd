...
```{r logo.img, echo=FALSE, include=TRUE, out.width='100%', fig.pos='H', eval=FALSE}
...
```{r image, fig.pos='H', echo=FALSE, include=TRUE, fig.align='center', out.width='90%',fig.cap= paste0("Fotos por Roberto Cinti, Proyecto Pantano")}
