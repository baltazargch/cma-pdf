...
if(all(is.na(fl)) && db.sp$sp_cat_nac_conserv_2019  %in% c('NA (No Aplicable)', 
                                                            'NE (No Evaluada)',
                                                            'EX (Extinta)')){
  cat('')
} else if(all(is.na(fl)) && !db.sp$sp_cat_nac_conserv_2019  %in% c('NA (No Aplicable)', 
                                                            'NE (No Evaluada)',
                                                            'EX (Extinta)')){
