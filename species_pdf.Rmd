...
```{r logo.img,  out.width='100%', fig.pos='H', eval=FALSE}
...
```{r photo, fig.pos='H',  fig.align='center', out.width='95%',fig.cap= paste0("Foto: ", credistPhoto[1])}
...
```{r title.addition.photos, results='asis'}
...
```{r map.sp,  results='asis'}
CMA_print_titles("ÁREA DE DISTRIBUCIÓN ACTUAL")%>% cat()
```

\vspace{-0.4cm}

```{r map, fig.pos="H",  out.width="100%"}
