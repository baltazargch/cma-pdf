...
\vspace{0.3cm}
{\fontsize{30}{36}\selectfont\textbf{Ciervo de los pantanos}}
\end{minipage}
...
{\centering \includegraphics[width=0.9\linewidth]{photos//Cetaartiodactyla/207_Blastocerus-dichotomus_15_Roberto-Cinti-Proyecto-Pantano_0} 

}

\caption{Foto: Roberto Cinti Proyecto Pantano}\label{fig:photo}
\end{figure}
...
\textbf{Cita sugerida:} Pereira, Javier A.; Varela, Diego; Aprile,
Gustavo; Cirignoli, Sebastián; Orozco, María Marcela; Lartigau,
Bernardo; De Angelo, Carlos; Giraudo, Alejandro R.. (2019).
\emph{Blastocerus dichotomus}. En: SAyDS--SAREM (eds.) Categorización
2019 de los mamíferos de Argentina según su riesgo de extinción. Lista
Roja de los mamíferos de Argentina.
\url{http://doi.org/10.31687/SaremLR.19.207}
...
\begin{figure}[H]\centering\includegraphics[width=0.90\textwidth]{photos//Cetaartiodactyla/207_Blastocerus-dichotomus_4_Hernan-Hadad.jpg}\caption{Foto: Hernan Hadad}\end{figure}

\begin{figure}[H]\centering\includegraphics[width=0.90\textwidth]{photos//Cetaartiodactyla/207_Blastocerus-dichotomus_9_Esteban-Argerich_1.jpg}\caption{Foto: Esteban Argerich}\end{figure}
...
\midrule
\cellcolor{gray!6}{VU (Vulnerable)} & \cellcolor{gray!6}{A3cde}\\
\bottomrule
\end{tabu}
...
\textbf{\cellcolor{gray!6}{\begin{justify}Orozco, María Marcela\end{justify}}} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{\begin{justify} Instituto de Ecología, Genética y Evolución de Buenos Aires (IEGEBA-CONICET) y Facultad de Ciencias Exactas y Naturales, Universidad de Buenos Aires, CABA, Argentina \end{justify}}\\
\textbf{\begin{justify}Lartigau, Bernardo\end{justify}} &  & \begin{justify} Programa Areas Protegidas, Fundación Vida Silvestre Argentina y Asociación para la Conservación y Estudio de la Naturaleza (ACEN), Buenos Aires, Argentina \end{justify}\\
...
\bgroup \MakeFramed{\hsize 0.7\textwidth\advance\hsize-\width \FrameRestore}
  ...
  Fecha de compilación: 2023-04-08 18:02:27\\
